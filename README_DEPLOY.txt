...
- 每張歷史校準版本卡可直接「一鍵回滾到此版本」
- 回滾確認畫面顯示版本、聯盟／玩法、累計筆數、命中率與穩定度
- 目前 Production 會清楚標示，不提供重複回滾按鈕
- 排名上方固定顯示目前各聯盟／玩法的 Production 與現有績效
- 每個回滾目標旁會同步顯示同範圍目前版本，確認時再做一次目前版／目標版比較
- 目前版剛部署且尚未累積正式紀錄時，會標示樣本不足，不會假裝有成績
